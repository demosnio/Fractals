...
public class Magnet extends Fractal
{
	public Magnet(double xFractal, double yFractal, double rFractal, double speed, int gridSize)
	{
		super(xFractal, yFractal, rFractal, speed, gridSize);
	}

	public Magnet(double xFractal, double yFractal, double rFractal, double speed, int gridSize, double xJulia, double yJulia)
	{
